...
/**
 * Geeft het Treinvervangend vervoer.
 * 
 * <p>Java class for AVVMaatregelType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AVVMaatregelType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="PeriodeKalender" type="{urn:ns:cdm:reisinformatie:data:vi:1}PeriodeKalenderType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "AVVMaatregelType", propOrder = {
    "maatregelTraject",
    "avvCode",
    "avvOmschrijving",
    "avvStop",
...
public class AVVMaatregelType {
    ...
    protected List<PeriodeKalenderType> periodeKalender;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the periodeKalender property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPeriodeKalender().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PeriodeKalenderType> getPeriodeKalender() {
        if (periodeKalender == null) {
            periodeKalender = new ArrayList<PeriodeKalenderType>();
        }
        return this.periodeKalender;
    }
